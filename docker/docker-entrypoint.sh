...
function UseNotes() {
  ...
  echo -e "\033[32m+-----------------------------------------------------------------------------------------------------------------+\033[0m"
  echo -e ''
  echo -e "\033[32m============================ 更多帮助请访问 https://gitee.com/h455257166/MyDocker ============================\033[0m"
  echo -e "\033[32m============================ Github & Gitee https://gitee.com/h455257166/MyDocker  ============================\033[0m"
  echo -e ''
}
...
if [[ ${ENABLE_WEB_PANEL} == true ]]; then
  ...
  echo -e "请访问 http://<内部或外部IP地址>:6789 登陆并修改配置...\n"
